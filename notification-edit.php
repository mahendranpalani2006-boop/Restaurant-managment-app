    ...
    <?php
        ...
        if (isset($_POST['btnEdit'])) {
            ...
            if (!empty($menu_image)) {
                ...
                $sql_query = "UPDATE tbl_notification SET title = ?, message = ?, image = ?, link = ? WHERE id = ?";
                ...
                $sql_query = "UPDATE tbl_notification SET title = ?, message = ?, link = ? WHERE id = ?";
                ...
                if ($update_result) {
                    redirect("notification-edit.php?id=$ID", "Changes saved...");
                } else {
        ...
        $sql_query = "SELECT id, title, message, image, link FROM tbl_notification WHERE id = ?";
                ...
                <div class="pmd-card-body">
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            <div class="lead">EDIT NOTIFICATION</div>
                        </div>
