...
<?php 
	...
	// total template
	$sql_total_template = "SELECT COUNT(*) as num FROM tbl_notification";
	...
	$sql_setting = "SELECT currency_code, currency_name, tax FROM tbl_settings, tbl_currency WHERE tbl_settings.currency_id = tbl_currency.currency_id";
	$setting_result = mysqli_query($connect, $sql_setting);
	$setting_row = mysqli_fetch_assoc($setting_result);	

	$sql_notif = "SELECT * FROM tbl_settings WHERE id = 1";
				...
				<div class="pmd-card-body" align="center">
					<table class="table pmd-table" id="table-propeller">
						...
						<tr>
							...
							<?php if ($notif_row['onesignal_app_id'] == '0' || $notif_row['onesignal_rest_api_key'] == '0') { ?>
